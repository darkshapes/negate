...
def main() -> None:
    ...
    model_blurb = f"Model to use. Default :{model_config.auto_model[0]}"
    ...
    calibrate_parser.add_argument("-m", "--model", choices=[repo for repo in model_config.list_models], default=model_config.auto_model[0], help=model_blurb)
